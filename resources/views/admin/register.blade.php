...
@section('Judul', 'TKIT BINA PRESTASI - Register Admin')
@section('content')

<div class="container-fluid pt-5 pb-5 bg-light menu">
    <div class="container text-center">
        <h1 class="display-2 mb-4">REGISTER ADMIN</h1>
    </div>
    <div class="container">
        <form method="POST" action="{{ route('admin.register.post') }}" class="row g-1">
            @csrf
